...
// BenchmarkR0004CELEvaluation benchmarks the CEL rule evaluation performance
func BenchmarkR0004CELEvaluation(b *testing.B) {
	ruleSpec, err := common.LoadRuleFromYAML("unexpected-capability-used.yaml")
	if err != nil {
	...
	for i := 0; i < b.N; i++ {
		...
		_, err := celEngine.EvaluateRule(eventMap, utils.CapabilitiesEventType, ruleSpec.Rules[0].Expressions.RuleExpression)
		if err != nil {
